...
const Shipping = () => {
  return (
    <div>
      <p>
        Shipping & Delivery Policy Last updated on Aug 9th 2023 For
        International buyers, orders are shipped and delivered through
        ...
        post office norms. YASH ARORA is not liable for any delay in delivery by
        ...
        0-2 days from the date of the order and payment or as per the delivery
        ...
        any issues in utilizing our services you may contact our helpdesk on or
